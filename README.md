# Next.js GitHub Actions CD + AWS CDK Infrastructure (Lightweight)

> For a more robust solution, check out the [aws-fargate-nextjs](https://github.com/dcastillogi/aws-fargate-nextjs) repository.
